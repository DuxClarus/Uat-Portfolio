...
class SpriteClass:
    ...
    def __init__(self,filename,x,y,width,height,columns,rows):
        ...
        self.upperLeft = Point2D(x, y)
        self.lowerRight = Point2D((x + self.width ) ,(y + self.height))
    ...
    #
    #  This function returns the width of the sprite post any scaling, etc
    #===========================================================================
    def get_width(self):
        return self.scaledFrameWidth
    #===========================================================================
    #  get_height
    #  Parameters:
    #     none
    ...
    #
    #  This function returns the height of the sprite post any scaling, etc
    #===========================================================================
    def get_height(self):
        return self.scaledFrameHeight   
    #===========================================================================
    #  Draw
    #  Parameters:
    ...
    def draw(self,screen):
        ...
        screen.blit(self.mod_image_list[self.frameNumber],(self.upperLeft.x,self.upperLeft.y))
